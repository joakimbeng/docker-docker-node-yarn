...
# mhart/alpine-node:8.5 slightly modified (added PATH env and installing bash, git and openssh)
ENV VERSION=v8.5.0 NPM_VERSION=5 YARN_VERSION=latest PATH=node_modules/.bin:$PATH
